...
export default function App() {
  ...
  const addTodo = () => {
    //* Yeni bir todo objesi oluştur ve todos statei'ne aktar.
    if (todo) {
  ...
  const updateTodos = id => {
    ...
    Alert.prompt(
      ...
      'Update', // Kullanıcın güncelleme yapması için buton üzerinde yazan metindir.
      ...
      newUpdateText => {
        if (newUpdateText) {
          ...
          saveTodos(updatedTodos); //* asyncstorage'i güncellendir.
        }
      },
